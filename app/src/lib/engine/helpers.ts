// helpers.ts — small utilities reused by narrative.ts and the PDF code.

import type { Gender, Lang, Pronouns } from "./types";
...
export function getPronouns(gender?: Gender, lang?: Lang): Pronouns {
