---
title: Visuelle Perseveration (Nachbilder und Spuren)
type: docs
slug: persistent_visual-perseveration
domain: visual
...
breadcrumb:
  ...
  - id: visual
    label: Visuell
  - id: persistent_visual-perseveration
    label: Visuelle Perseveration (Nachbilder und Spuren)
prev: /symptom-guide/persistent_visual-loss
next: /symptom-guide/persistent_light-sensitivity
siblings:
...
![Patientenkunstwerk, das ein Nachbild darstellt — ein Bild der Takelung eines Schiffes, das verweilte, nachdem der Patient die ursprüngliche Szene wegschaute.](images/p-overview__Sofia__Greene_Afterimage_ship_small_400_en.jpg)
*Patientenkunstwerk, das ein Nachbild darstellt — ein Bild der Takelung eines Schiffes, das verweilte, nachdem der Patient die ursprüngliche Szene wegschaute.*


## Wie Betroffene es beschreiben {#patient-accounts}

> „Ich schaue auf etwas, drehe meinen Kopf und sehe es dann wieder. Oder ich schaue auf etwas, bewege es und sehe es immer noch, wo ich es von bewegt habe (das längste Zeit, die ein Bild in meinem Sichtfeld blieb, ist 8 Sekunden). Ich habe die größten Probleme beim Fernsehen und Fahren."
> — *S.*

> „Normalerweise sind meine Symptome auf Flimmerskotom beschränkt, das ‚erzwungene Erinnerung/traumähnlicher' Zustand, manchmal gefolgt von Kopfschmerz, aber in letzter Zeit hatte ich kurzzeitig Taubheit im Unterkiefer/Lippe/rechten Handfingern."
> — *M.C.*

> „Ich dachte, ich bekäme keine Aura mit meinen Migränen; kein Sternschnuppen oder funkelt, blinkende Muster. Aber ich tun - manchmal - bekommen Tunnelsehen und danach scheint die Welt glänzend, stilisiert, Schwarzweiß."
> — *A.D.*

## Unterformen {#subtypes}

### Negative Nachbilder {#negative-afterimages}
...
### Positive Nachbilder {#positive-afterimages}
