---
title: Other Persistent Visual Symptoms
type: docs
...
breadcrumb:
  ...
  - id: persistent_other-visual-symptoms
    label: Other Persistent Visual Symptoms
...
> "Yep I get them - yuk: Lots of visual disturbances with coloured zig-zags that flash with tunnel vision. For me, the first sign of an impending migraine is an inability to recognise faces."
> — *P.J.*
...
> "When I was looking at the cover of a clothbound book, with a decorative border and the title in the center. When I looked at the title, it disappeared... The texture and appearance of the fabric extended across the blind spot."
> — *D.P.B.S.*
...
### Visual Hallucinations - Kaleidoscope Form {#visual-hallucinations-kaleidoscope}
...
### Visual Hallucinations - Curve Form {#visual-hallucinations-curve}
...
### Cinematographic Vision {#cinematographic-vision}
