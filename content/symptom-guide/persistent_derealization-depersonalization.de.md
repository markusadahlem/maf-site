---
title: Persistierende Derealisation und Depersonalisation
type: docs
slug: persistent_derealization-depersonalization
domain: cognitive
domain_label: Kognitiv
breadcrumb:
  - id: persistent
    label: Persistierende Aurasymptome
  - id: cognitive
    label: Kognitiv
  - id: persistent_derealization-depersonalization
    label: Persistierende Derealisation und Depersonalisation
prev: /symptom-guide/persistent_cognitive-problems
next: false
siblings:
  - persistent_cognitive-problems
  - persistent_derealization-depersonalization
---
...
> "Mein Migräneerlebnis beginnt mit Hunger. Ich fühle mich plötzlich hungrig. Kurz danach wird mein Sehen 'distanziert'. Es ist ein bisschen wie das Sehen der Welt auf einem Bildschirm projiziert."
> — *A.W.*

> "Ich bekomme Derealisation/Depersonalisation, wenn ich eine Migräne habe..."
> — *J.*

> "Übrigens habe ich eine kombinierte Form von Migräne. Klassisch und basilär. Ich leide von Anfang an unter Depersonalisation, Aura, bis zur kompletten Blindheit, Paresen, Sprachverlust, usw."
> — *I.*
