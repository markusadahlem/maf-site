---
title: Synaesthesia (Mixing of the Senses)
type: docs
slug: transitory_synaesthesia
...
breadcrumb:
  ...
  - id: transitory_synaesthesia
    label: Synaesthesia (Mixing of the Senses)
prev: /symptom-guide/transitory_forced-reminiscence
next: /symptom-guide/transitory_other-higher-cortical
siblings:
...
![The Audio Aura Ball: an object that changes colour in response to the pitch of music — a visual analogy for auditory-visual synaesthesia.](images/t-synaesthesia__AudioAuraBall_A_en.gif)
...
![E.F., *Synaesthetic perception of migraine headache*, 2006. Artwork depicting the synaesthetic experience of a migraine.](images/t-synaesthesia__galg03_small_400_en.jpg)
...
> "I have long believed, in my untutored layperson's opinion, that I have a mild case of synesthesia, the phenomenon which causes a stimulus in one modality to evoke a response in another modality. The arrival of seven o'clock, for example, is registered in my consciousness by means of the color brown, regardless of morning or evening hours."
> — *B.Z.*

> "I can relate to this. I'm a HA sufferer (13 years), and I have always associated colors to the days of the week (Saturday is black, Sunday yellow, etc.)."
> — *T.E.*

## Subtypes {#subtypes}

### Auditory-Visual Synaesthesia {#auditory-visual}
Sounds trigger visual experiences. Music, voices, or environmental noises produce color or geometric patterns.

### Colour-Number Associations {#colour-number}
...
### Chromaesthesia (Sound-Color Perception) {#chromaesthesia}
