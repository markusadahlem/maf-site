---
title: Auditorische Aurasymptome
type: docs
slug: transitory_auditory-symptoms
domain: brainstem
domain_label: Hirnstamm / Basilaris-Typ
breadcrumb:
  - id: transitory
    label: Vorübergehende Aurasymptome
  - id: brainstem
    label: Hirnstamm / Basilaris-Typ
  - id: transitory_auditory-symptoms
    label: Auditorische Aurasymptome
prev: false
next: false
siblings:
  - transitory_auditory-symptoms
---
...
![Kunstwerk, das die Erfahrung auditorischer Migräne-Aurasymptome darstellt.](images/t-auditory-symptoms__pic_creative5Small_en.gif)
*Kunstwerk, das die Erfahrung auditorischer Migräne-Aurasymptome darstellt.*


## Wie Betroffene es beschreiben {#patient-accounts}

> "Ich erlebe ein Rauschgeräusch und alles klingt fern, etwa einen Tag lang 'vor' einer Migräne, es ist also definitiv nicht auf Medikamente zurückzuführen. Es setzt sich manchmal in die Migräne fort."
> — *J.*

> "Mein Mann sagt, dass ich sehr laut werde (nun ja, lauter als sonst), wenn ich eine Migräne bekommen werde. Alles wirkt so fern auf mich. Ich habe noch nichts genommen."
> — *R.N.*

> "Letzte Nacht hatte ich Kopfschmerzen, also bin ich aus dem Bett aufgestanden, um etwas zu trinken zu holen, und schaltete den Fernseher ein, während ich ein Glas Milch trank... Nach etwa 2 Minuten begannen meine Ohren zu schmerzen (wie ein Ohrenschmerz), und etwa eine Minute später bemerkte ich, dass die Lautstärke des Fernsehers plötzlich abnahm, als würde ich auf den Lautstärkeregler drücken."
> — *sceptictank*

## Unterformen {#subtypes}

### Gehörverminderung {#decreased-hearing}
