---
title: Other Disturbances of Higher Brain Functions
type: docs
...
breadcrumb:
  ...
  - id: transitory_other-higher-cortical
    label: Other Disturbances of Higher Brain Functions
...
![Alice's encounter with Humpty Dumpty, from Lewis Carroll's *Through the Looking-Glass*, 1872. Prosopagnosia — temporary inability to recognise faces — is one of the documented higher cortical disturbances of migraine aura.](images/t-other-higher-cortical__HumptyDumpty_en.bmp)
*Alice's encounter with Humpty Dumpty, from Lewis Carroll's *Through the Looking-Glass*, 1872. Prosopagnosia — temporary inability to recognise faces — is one of the documented higher cortical disturbances of migraine aura.*


## How patients describe it {#patient-accounts}

> "I thought I did not get aura with my migraines; no seeing stars or sparkly, flashy patterns. But I do - sometimes - get tunnel vision and after that the world seems glossy, stylized, black&white (sometimes) or it gets either very sharp or very fuzzy."
> — *A.D.*

> "For me, the first sign of an impending migraine is an inability to recognise faces. At that point I go straight to bed with neurofen (iboprofen) or aspirin in a darken room and can usually sleep through the entire event (about 8 hours)."
> — *P.J.*

> "Sometimes my surrounding take on an odd orange/yellow color before a migraine strikes."
> — *M.*

## Subtypes {#subtypes}

### Achromatopsia (Loss of Colour Vision) {#achromatopsia}
The world appears in shades of gray or lacks its normal color. This can be accompanied by blurred vision or tunnel vision.

### Chromatopsia (Color Distortion) {#chromatopsia}
Colors appear altered or distorted—objects may take on unusual tints like orange, yellow, or other unexpected hues.

### Prosopagnosia (Face Blindness) {#prosopagnosia}
...
### Allochiria (Sensation Reversal) {#allochiria}
...
### Balint's Syndrome (Complex Visual Processing Disorder) {#balints-syndrome}
